-- gitsigns.nvim: show git status in the sign column and provide hunk actions.
---@type LazyPluginSpec
return {
  ...
  opts = {
    on_attach = function(bufnr)
      ...
      -- Navigation between hunks (falls back to diff navigation in diff mode).
      map('n', ']c', function()
        if vim.wo.diff then
      ...
      map('n', '<leader>thi', gs.preview_hunk_inline, { desc = '[T]oggle inline [H]unk preview' })
